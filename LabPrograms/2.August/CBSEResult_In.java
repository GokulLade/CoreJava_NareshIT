...
class CBSEResult_In
{
	public void acceptDetailAndSubmit(String studentName,long rollNo,String schoolRegNo,String schoolName, char gender,String citizenship,String board){
		...
		if(schoolRegNo.equals("CBSE01-100") && citizenship.equals("INDIA") && board.equals("CBSE")){
			...
			cbse.displayDetails(studentName,rollNo,schoolRegNo,schoolName,gender,citizenShip,board,math,science,english,socialScience,physicalEducation,g);
		}
	}
	...
	public void displayDetails(String studentName,long rollNo,String schoolRegNo, String schoolName,char gender, String citizenship,String board,int math,int science,int english,int socialScience,int physicalEducation,char g){
	...
	public static void main(String[] args) 
	{
		...
		cb.acceptDetailAndSubmit("Gokul",000007,"CBSE01-100","DAV",'M',"INDIA"
,"CBSE");
	}
}
